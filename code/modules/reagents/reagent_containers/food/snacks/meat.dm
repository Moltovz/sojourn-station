/obj/item/reagent_containers/snacks/meat
	...
	slice_path = /obj/item/reagent_containers/snacks/rawcutlet
	slices_num = 3
...
/obj/item/reagent_containers/snacks/meat/proc/initialize_genetics(mob/living/meat_source)
...
/obj/item/reagent_containers/snacks/meat/pork
	...
	slice_path = /obj/item/reagent_containers/snacks/rawbacon
...
/obj/item/reagent_containers/snacks/meat/termitemeat
...
/obj/item/reagent_containers/snacks/meat/spider
...
/obj/item/reagent_containers/snacks/meat/spider/reaper_spider
	preloaded_reagents = list("protein" = 8, "pararein" = 8, "stoxin" = 8, "ammonia" = 4)

/obj/item/reagent_containers/snacks/meat/spider/nurse
...
/obj/item/reagent_containers/snacks/meat/spider/midwife
	preloaded_reagents = list("protein" = 8, "pararein" = 8, "mutagen" = 8, "ammonia" = 4)

/obj/item/reagent_containers/snacks/meat/spider/cave_spider
	preloaded_reagents = list("protein" = 8, "pararein" = 8, "frostoil" = 8, "ammonia" = 4)

/obj/item/reagent_containers/snacks/meat/spider/recluse
	preloaded_reagents = list("protein" = 8, "pararein" = 8, "zombiepowder" = 6, "ammonia" = 4)

/obj/item/reagent_containers/snacks/meat/spider/queen
...
/obj/item/reagent_containers/snacks/meat/primal
	name = "meat"
...
/obj/item/reagent_containers/snacks/meat/fungi
	name = "fungal slab"
...
/obj/item/reagent_containers/snacks/meat/chicken
	name = "poultry"
	desc = "Poultry meat, might be chicken or any other avian species."
	icon_state = "birdmeat"
	filling_color = "#EDA897"
	preloaded_reagents = list("protein" = 8)
	slice_path = /obj/item/reagent_containers/snacks/chickenbreast
	slices_num = 4
