#define DEFIB_TIME_LIMIT (120 MINUTES) //past this many seconds, defib is useless.
#define DEFIB_TIME_LOSS  (30 MINUTES) //past this many seconds, brain damage occurs.
	...
	if(!H.client && !H.teleop)
		for(var/mob/observer/ghost/ghost in GLOB.player_list)
			if(ghost.mind == H.mind)
				to_chat(ghost, "<b><font color = #0012b5><font size = 3>Someone is attempting to resuscitate you. Re-enter your body if you want to be revived!</b> (Verbs -> Ghost -> Re-enter corpse)</font></font>")
				break
