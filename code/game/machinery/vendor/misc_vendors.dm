...
/obj/machinery/vending/gamers
	...
	products = list(
					...
					/obj/item/cardholder/precon = 20,
					/obj/item/cardholder/precon/dozer = 10,
					/obj/item/cardholder/precon/skeletonappreciation = 10,
...
/obj/machinery/vending/neko
	...
	prices = list(/obj/item/storage/box/costume/nekomaid = 200,
					...
					/obj/item/paper/card/cat = 10,
					/mob/living/simple/cat/kitten = 500 )
	contraband = list(/mob/living/simple/cat/kitten = 1)
	idle_power_usage = 50
	auto_price = FALSE
	always_open = TRUE
