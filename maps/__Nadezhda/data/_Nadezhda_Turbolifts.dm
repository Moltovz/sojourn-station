...
//DORMS ELEVATOR AREAS
/area/turbolift/Dorms/levelone
	name = "Nadezhda Underground"
	lift_floor_label = "Dormitories level one"
	lift_floor_name = "Floor One"
	lift_announce_str = "Transition complete. Welcome to the Nadezhda Underground."
	base_turf = /turf/simulated/shuttle/floor/mining

/area/turbolift/Dorms/transition
	name = "Transition One"
	lift_announce_str = "Transition complete. Welcome to Base Level 1."
	base_turf = /turf/simulated/shuttle/floor/mining

/area/turbolift/Dorms/leveltwo
	name = "Nadezhda Surface"
	lift_floor_label = "Dormitories level two"
	lift_floor_name = "Floor Two"
	lift_announce_str = "Transition complete. Welcome to Floor 1."

/area/turbolift/Dorms/transitiontwo
	name = "Transition Three"
	lift_announce_str = "Transition complete. Welcome to Base Level 3."
	base_turf = /turf/simulated/shuttle/floor/mining

/area/turbolift/Dorms/levelthree
	name = "Nadezhda Surface"
	lift_floor_label = "Dormitories level three"
	lift_floor_name = "Floor Three"
	lift_announce_str = "Transition complete. Welcome to Floor 3."

//DORM ELEVATOR
/obj/turbolift_map_obj/turbolift_map_base/Nadezhda/Dorms
	name = "Turbolift"
	lift_size_x = 3 // Size of the actual lift, shaft walls are extra.
	lift_size_y = 3
	icon = 'icons/modules/turbolift/turbolift_preview_3x3 - no walls.dmi'
